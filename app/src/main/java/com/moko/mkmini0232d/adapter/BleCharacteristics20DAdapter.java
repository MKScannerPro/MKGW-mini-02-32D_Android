...
public class BleCharacteristics20DAdapter extends BaseMultiItemQuickAdapter<BleOtherChar, BaseViewHolder> {
    public BleCharacteristics20DAdapter(List<BleOtherChar> data) {
        super(data);
