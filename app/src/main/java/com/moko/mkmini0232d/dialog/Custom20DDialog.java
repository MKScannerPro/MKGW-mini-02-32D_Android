...
public class Custom20DDialog extends Dialog {

    public Custom20DDialog(Context context) {
        super(context);
    }

    public Custom20DDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public Custom20DDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme  
            final Custom20DDialog dialog = new Custom20DDialog(context, R.style.Dialog);
