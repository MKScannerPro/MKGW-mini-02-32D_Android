...
import com.moko.mkmini0232d.databinding.ActivityFilterTlm20dBinding;
...
public class FilterTLM20DActivity extends BaseActivity<ActivityFilterTlm20dBinding> {
    ...
    @Override
    protected ActivityFilterTlm20dBinding getViewBinding() {
        return ActivityFilterTlm20dBinding.inflate(getLayoutInflater());
    }
