...
import com.moko.mkmini0232d.databinding.ActivityFilterBxpTagMini0232dBinding;
...
public class FilterBXPTagActivity extends BaseActivity<ActivityFilterBxpTagMini0232dBinding> {
    ...
    protected void onCreate() {
        ...
        mBind.tvTitle.setText(mMokoDevice.deviceType != 0x70 ? "BXP- Tag/Sensor" : "BXP- Tag");
        mBind.cbBxpTag.setText(mMokoDevice.deviceType != 0x70 ? "BXP- Tag/Sensor" : "BXP- Tag");
