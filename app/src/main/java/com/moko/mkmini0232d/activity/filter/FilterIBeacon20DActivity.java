...
import com.moko.mkmini0232d.databinding.ActivityFilterIbeacon20dBinding;
...
public class FilterIBeacon20DActivity extends BaseActivity<ActivityFilterIbeacon20dBinding> {
    ...
    @Override
    protected ActivityFilterIbeacon20dBinding getViewBinding() {
        return ActivityFilterIbeacon20dBinding.inflate(getLayoutInflater());
    }
