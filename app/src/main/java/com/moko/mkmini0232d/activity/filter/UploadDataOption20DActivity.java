...
import com.moko.mkmini0232d.databinding.ActivityUploadDataOption20dBinding;
...
public class UploadDataOption20DActivity extends BaseActivity<ActivityUploadDataOption20dBinding> {
    ...
    @Override
    protected ActivityUploadDataOption20dBinding getViewBinding() {
        return ActivityUploadDataOption20dBinding.inflate(getLayoutInflater());
    }
