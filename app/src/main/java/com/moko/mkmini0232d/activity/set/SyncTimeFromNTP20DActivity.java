...
import com.moko.mkmini0232d.databinding.ActivitySyncFromNtp20dBinding;
...
public class SyncTimeFromNTP20DActivity extends BaseActivity<ActivitySyncFromNtp20dBinding> {
    ...
    @Override
    protected ActivitySyncFromNtp20dBinding getViewBinding() {
        return ActivitySyncFromNtp20dBinding.inflate(getLayoutInflater());
    }
