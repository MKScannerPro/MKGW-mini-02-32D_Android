...
import com.moko.mkmini0232d.databinding.ActivitySystemTime20dBinding;
...
public class SystemTime20DActivity extends BaseActivity<ActivitySystemTime20dBinding> {
    ...
    @Override
    protected ActivitySystemTime20dBinding getViewBinding() {
        return ActivitySystemTime20dBinding.inflate(getLayoutInflater());
    }
    ...
    public void onSyncTimeFromNTP(View view) {
        ...
        Intent i = new Intent(this, SyncTimeFromNTP20DActivity.class);
