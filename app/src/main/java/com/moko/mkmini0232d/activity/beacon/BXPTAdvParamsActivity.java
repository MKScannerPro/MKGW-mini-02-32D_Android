...
import com.moko.mkmini0232d.databinding.ActivityBxpCAdvParamsMini0232dBinding;
import com.moko.mkmini0232d.databinding.LayoutSlotBinding;
import com.moko.mkmini0232d.entity.AdvParamInfo;
import com.moko.mkmini0232d.entity.MQTTConfig;
import com.moko.mkmini0232d.entity.MokoDevice;
import com.moko.mkmini0232d.entity.SlotAdvParams;
import com.moko.mkmini0232d.entity.TxPowerTagEnum;
...
public class BXPTAdvParamsActivity extends BaseActivity<ActivityBxpCAdvParamsMini0232dBinding> {
    ...
    @Override
    protected ActivityBxpCAdvParamsMini0232dBinding getViewBinding() {
        return ActivityBxpCAdvParamsMini0232dBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_BXP_T_ADV_PARAMS_READ) {
            dismissLoadingProgressDialog();
            ...
            for (SlotAdvParams slotAdvParams : result.data.adv_param) {
                ...
                if (slotAdvParams.channel == 0) {
                    ...
                    mBind.layoutSlot1.layoutAdvParams.etAdvInterval.setText(String.valueOf(slotAdvParams.adv_interval));
                    ...
                    mBind.layoutSlot2.layoutAdvParams.etAdvInterval.setText(String.valueOf(slotAdvParams.adv_interval));
                    ...
                    mBind.layoutSlot3.layoutAdvParams.etAdvInterval.setText(String.valueOf(slotAdvParams.adv_interval));
                    ...
                    mBind.layoutSlot4.layoutAdvParams.etAdvInterval.setText(String.valueOf(slotAdvParams.adv_interval));
                    ...
                    mBind.layoutSlot5.layoutAdvParams.etAdvInterval.setText(String.valueOf(slotAdvParams.adv_interval));
                    ...
                    mBind.layoutSlot6.layoutAdvParams.etAdvInterval.setText(String.valueOf(slotAdvParams.adv_interval));
                }
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_BXP_T_ADV_PARAMS_WRITE) {
            dismissLoadingProgressDialog();
            mHandler.removeMessages(0);
    ...
    private void getAdvParams() {
        int msgId = MQTTConstants.CONFIG_MSG_ID_BLE_BXP_T_ADV_PARAMS_READ;
    ...
    private void setAdvParamsConfig(int channel) {
        ...
        int msgId = MQTTConstants.CONFIG_MSG_ID_BLE_BXP_T_ADV_PARAMS_WRITE;
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("mac", mMac);
