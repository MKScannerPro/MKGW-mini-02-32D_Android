...
public class WifiSettingsActivity extends BaseActivity<ActivityWifiSettingsMimi0232dBinding> {
    ...
    protected void onCreate() {
        ...
        int beaconType = getIntent().getIntExtra(AppConstants.EXTRA_KEY_BEACON_TYPE, 0x70);
        boolean isFirstConfig = getIntent().getBooleanExtra(AppConstants.EXTRA_KEY_FIRST_CONFIG, false);
        mBind.ivSearch.setVisibility(beaconType == 0x71 && isFirstConfig ? View.VISIBLE : View.GONE);
