...
import com.moko.mkmini0232d.databinding.ActivityFilterBxpTag20dBinding;
...
public class FilterBXPTag20DActivity extends BaseActivity<ActivityFilterBxpTag20dBinding> {
    ...
    @Override
    protected ActivityFilterBxpTag20dBinding getViewBinding() {
        return ActivityFilterBxpTag20dBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_BXP_TAG) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : tagList) {
                    ...
                    View v = LayoutInflater.from(FilterBXPTag20DActivity.this).inflate(R.layout.item_mac_address_filter, mBind.llTagId, false);
