...
import com.moko.mkmini0232d.databinding.ActivityFilterOther20dBinding;
...
public class FilterOther20DActivity extends BaseActivity<ActivityFilterOther20dBinding> {
    ...
    @Override
    protected ActivityFilterOther20dBinding getViewBinding() {
        return ActivityFilterOther20dBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_OTHER) {
            ...
            if (number > 0) {
                ...
                for (JsonElement jsonElement : ruleList) {
                    ...
                    View v = LayoutInflater.from(FilterOther20DActivity.this).inflate(R.layout.item_other_filter_remote, mBind.llFilterCondition, false);
