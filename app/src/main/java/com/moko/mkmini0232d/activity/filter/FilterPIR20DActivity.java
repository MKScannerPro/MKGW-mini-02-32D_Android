...
import com.moko.mkmini0232d.databinding.ActivityFilterPir20dBinding;
...
public class FilterPIR20DActivity extends BaseActivity<ActivityFilterPir20dBinding> {
    ...
    @Override
    protected ActivityFilterPir20dBinding getViewBinding() {
        return ActivityFilterPir20dBinding.inflate(getLayoutInflater());
    }
