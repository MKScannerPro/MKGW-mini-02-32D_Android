...
import com.moko.mkmini0232d.databinding.ActivityFilterNanoMini0232dBinding;
...
public class FilterNanoActivity extends BaseActivity<ActivityFilterNanoMini0232dBinding> {
    ...
    @Override
    protected ActivityFilterNanoMini0232dBinding getViewBinding() {
        return ActivityFilterNanoMini0232dBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_NANO) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : codeList) {
                    ...
                    View v = LayoutInflater.from(FilterNanoActivity.this).inflate(R.layout.item_nano_filter_mini02_32d, mBind.llId, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.item_nano_filter_mini02_32d, mBind.llId, false);
        TextView title = v.findViewById(R.id.tvTitle);
