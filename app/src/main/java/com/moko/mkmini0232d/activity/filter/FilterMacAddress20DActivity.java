...
import com.moko.mkmini0232d.databinding.ActivityFilterMacAddress20dBinding;
...
public class FilterMacAddress20DActivity extends BaseActivity<ActivityFilterMacAddress20dBinding> {
    ...
    @Override
    protected ActivityFilterMacAddress20dBinding getViewBinding() {
        return ActivityFilterMacAddress20dBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_MAC_ADDRESS) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterMacAddress20DActivity.this).inflate(R.layout.item_mac_address_filter, mBind.llMacAddress, false);
