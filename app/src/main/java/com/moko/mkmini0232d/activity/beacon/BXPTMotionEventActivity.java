...
import com.moko.mkmini0232d.databinding.ActivityBxpTMotionEventMini0232dBinding;
...
public class BXPTMotionEventActivity extends BaseActivity<ActivityBxpTMotionEventMini0232dBinding> {
    ...
    @Override
    protected ActivityBxpTMotionEventMini0232dBinding getViewBinding() {
        return ActivityBxpTMotionEventMini0232dBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_BXP_T_MOTION_EVENT_CLEAR) {
            dismissLoadingProgressDialog();
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_BXP_T_MOTION_EVENT) {
            ...
            mBind.tvMotionEventData.setText(String.valueOf(count));
        }
    ...
    private void getMotionEvent() {
        int msgId = MQTTConstants.CONFIG_MSG_ID_BLE_BXP_T_MOTION_EVENT;
    ...
    private void clearMotionData() {
        int msgId = MQTTConstants.CONFIG_MSG_ID_BLE_BXP_T_MOTION_EVENT_CLEAR;
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("mac", mMac);
        String message = assembleWriteCommonData(msgId, mMokoDevice.mac, jsonObject);
        try {
