...
import com.moko.mkmini0232d.databinding.ActivityFilterBxpButton20dBinding;
...
public class FilterBXPButton20DActivity extends BaseActivity<ActivityFilterBxpButton20dBinding> {
    ...
    protected void onCreate() {
        ...
        mHandler.postDelayed(() -> {
            ...
            FilterBXPButton20DActivity.this.finish();
        }, 30 * 1000);
    ...
    @Override
    protected ActivityFilterBxpButton20dBinding getViewBinding() {
        return ActivityFilterBxpButton20dBinding.inflate(getLayoutInflater());
    }
