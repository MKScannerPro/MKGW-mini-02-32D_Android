...
import com.moko.mkmini0232d.databinding.ActivityScannerFilter20dBinding;
...
public class ScannerFilter20DActivity extends BaseActivity<ActivityScannerFilter20dBinding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerFilter20dBinding getViewBinding() {
        return ActivityScannerFilter20dBinding.inflate(getLayoutInflater());
    }
