...
import com.moko.mkmini0232d.databinding.ActivityMkTofAdvParamsMini0232dBinding;
...
public class MKTOFAdvParamsActivity extends BaseActivity<ActivityMkTofAdvParamsMini0232dBinding> {
    ...
    @Override
    protected ActivityMkTofAdvParamsMini0232dBinding getViewBinding() {
        return ActivityMkTofAdvParamsMini0232dBinding.inflate(getLayoutInflater());
    }
