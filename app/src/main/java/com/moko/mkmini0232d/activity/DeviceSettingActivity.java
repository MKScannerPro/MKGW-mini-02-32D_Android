...
import com.moko.mkmini0232d.activity.add.AdvSettingsActivity;
import com.moko.mkmini0232d.activity.add.AdvertiseIBeaconActivity;
import com.moko.mkmini0232d.activity.modify.ModifySettingsActivity;
import com.moko.mkmini0232d.activity.settings.ButtonResetActivity;
import com.moko.mkmini0232d.activity.settings.CommunicationTimeoutActivity;
import com.moko.mkmini0232d.activity.settings.DeviceInfoActivity;
import com.moko.mkmini0232d.activity.settings.IndicatorSettingActivity;
import com.moko.mkmini0232d.activity.settings.NetworkReportIntervalActivity;
import com.moko.mkmini0232d.activity.settings.OTAActivity;
import com.moko.mkmini0232d.activity.settings.ReconnectTimeoutActivity;
import com.moko.mkmini0232d.activity.settings.SystemTimeActivity;
import com.moko.mkmini0232d.base.BaseActivity;
import com.moko.mkmini0232d.databinding.ActivityDeviceSettingMini0232dBinding;
...
public class DeviceSettingActivity extends BaseActivity<ActivityDeviceSettingMini0232dBinding> {
    ...
    protected void onCreate() {
        ...
        mBind.tvReconnectTimeout.setVisibility(mMokoDevice.deviceType == 0x70 ? View.VISIBLE : View.GONE);
        mBind.tvAdvIbeacon.setVisibility(mMokoDevice.deviceType == 0x70 ? View.VISIBLE : View.GONE);
        mBind.tvAdvSettings.setVisibility(mMokoDevice.deviceType != 0x70 ? View.VISIBLE : View.GONE);
    }

    @Override
    protected ActivityDeviceSettingMini0232dBinding getViewBinding() {
        return ActivityDeviceSettingMini0232dBinding.inflate(getLayoutInflater());
    }
    ...
    public void onEditName(View view) {
        ...
        View content = LayoutInflater.from(this).inflate(R.layout.modify_name_mini02_32d, null);
    ...
    public void onAdvSettings(View view) {
        start(AdvSettingsActivity.class);
    }
