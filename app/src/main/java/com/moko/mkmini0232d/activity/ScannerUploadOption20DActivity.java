...
import com.moko.mkmini0232d.activity.filter.DuplicateDataFilter20DActivity;
import com.moko.mkmini0232d.activity.filter.FilterAdvName20DActivity;
import com.moko.mkmini0232d.activity.filter.FilterMacAddress20DActivity;
import com.moko.mkmini0232d.activity.filter.FilterRawDataSwitch20DActivity;
import com.moko.mkmini0232d.activity.filter.UploadDataOption20DActivity;
import com.moko.mkmini0232d.base.BaseActivity;
import com.moko.mkmini0232d.databinding.ActivityScannerUploadOption20dBinding;
import com.moko.mkmini0232d.dialog.Bottom20DDialog;
...
public class ScannerUploadOption20DActivity extends BaseActivity<ActivityScannerUploadOption20dBinding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerUploadOption20dBinding getViewBinding() {
        return ActivityScannerUploadOption20dBinding.inflate(getLayoutInflater());
    }
    ...
    public void onDuplicateDataFilter(View view) {
        ...
        Intent i = new Intent(this, DuplicateDataFilter20DActivity.class);
    ...
    public void onUploadDataOption(View view) {
        ...
        Intent i = new Intent(this, UploadDataOption20DActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onFilterByMac(View view) {
        ...
        Intent i = new Intent(this, FilterMacAddress20DActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onFilterByName(View view) {
        ...
        Intent i = new Intent(this, FilterAdvName20DActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onFilterByRawData(View view) {
        ...
        Intent i = new Intent(this, FilterRawDataSwitch20DActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
