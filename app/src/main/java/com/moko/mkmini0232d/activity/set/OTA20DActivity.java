...
import com.moko.mkmini0232d.databinding.ActivityOta20dBinding;
...
public class OTA20DActivity extends BaseActivity<ActivityOta20dBinding> {
    ...
    @Override
    protected ActivityOta20dBinding getViewBinding() {
        return ActivityOta20dBinding.inflate(getLayoutInflater());
    }
