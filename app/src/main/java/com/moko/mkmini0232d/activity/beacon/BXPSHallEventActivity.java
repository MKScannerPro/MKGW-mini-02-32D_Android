...
import com.moko.mkmini0232d.databinding.ActivityBxpSHallEventMini0232dBinding;
...
public class BXPSHallEventActivity extends BaseActivity<ActivityBxpSHallEventMini0232dBinding> {
    ...
    @Override
    protected ActivityBxpSHallEventMini0232dBinding getViewBinding() {
        return ActivityBxpSHallEventMini0232dBinding.inflate(getLayoutInflater());
    }
