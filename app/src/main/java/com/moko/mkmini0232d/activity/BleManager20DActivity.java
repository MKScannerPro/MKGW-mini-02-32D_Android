...
import com.moko.mkmini0232d.adapter.BleDevice20DAdapter;
import com.moko.mkmini0232d.base.BaseActivity;
import com.moko.mkmini0232d.databinding.ActivityBleDevices20dBinding;
import com.moko.mkmini0232d.db.DBTools20D;
...
public class BleManager20DActivity extends BaseActivity<ActivityBleDevices20dBinding> implements BaseQuickAdapter.OnItemChildClickListener {
    private MokoDevice mMokoDevice;
    private MQTTConfig appMqttConfig;
    private String mAppTopic;
    private BleDevice20DAdapter mAdapter;
    ...
    protected void onCreate() {
        ...
        mAdapter = new BleDevice20DAdapter();
    ...
    @Override
    protected ActivityBleDevices20dBinding getViewBinding() {
        return ActivityBleDevices20dBinding.inflate(getLayoutInflater());
    }
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools20D.getInstance(BleManager20DActivity.this).selectDevice(mMokoDevice.mac);
    ...
    public void onFilter(View view) {
        ...
        scanFilterDialog.setOnScanFilterListener((filterName, filterMac, filterRssi) -> {
            BleManager20DActivity.this.filterName = filterName;
            BleManager20DActivity.this.filterMac = filterMac;
            BleManager20DActivity.this.filterRssi = filterRssi;
            if (!TextUtils.isEmpty(filterName)
                    || !TextUtils.isEmpty(filterMac)
                    || filterRssi != -127) {
        ...
        if (bleDevice.type_code == 7) {
            ...
            dialog.setOnPasswordClicked(password -> {
                ...
                mHandler.postDelayed(() -> {
                    dismissLoadingProgressDialog();
                    ToastUtils.showToast(BleManager20DActivity.this, "Setup failed");
                }, 50 * 1000);
