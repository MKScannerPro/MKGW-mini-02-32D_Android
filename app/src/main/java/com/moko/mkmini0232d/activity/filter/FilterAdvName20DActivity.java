...
import com.moko.mkmini0232d.databinding.ActivityFilterAdvName20dBinding;
...
public class FilterAdvName20DActivity extends BaseActivity<ActivityFilterAdvName20dBinding> {
    ...
    @Override
    protected ActivityFilterAdvName20dBinding getViewBinding() {
        return ActivityFilterAdvName20dBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_ADV_NAME) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterAdvName20DActivity.this).inflate(R.layout.item_adv_name_filter, mBind.llDavName, false);
