...
import com.moko.mkmini0232d.databinding.ActivityFilterMkTof20dBinding;
...
public class FilterMKTOF20DActivity extends BaseActivity<ActivityFilterMkTof20dBinding> {
    ...
    @Override
    protected ActivityFilterMkTof20dBinding getViewBinding() {
        return ActivityFilterMkTof20dBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_TOF) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : codeList) {
                    ...
                    View v = LayoutInflater.from(FilterMKTOF20DActivity.this).inflate(R.layout.item_tof_filter, mBind.llMfgCode, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.item_tof_filter, mBind.llMfgCode, false);
        TextView title = v.findViewById(R.id.tv_mfg_code_title);
