...
import com.moko.mkmini0232d.databinding.ActivityMkAdvParamsMini0232dBinding;
...
public class MKAdvParamsActivity extends BaseActivity<ActivityMkAdvParamsMini0232dBinding> {
    ...
    @Override
    protected ActivityMkAdvParamsMini0232dBinding getViewBinding() {
        return ActivityMkAdvParamsMini0232dBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_MK_PIR_ADV_PARAMS_READ) {
            dismissLoadingProgressDialog();
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_MK_PIR_ADV_PARAMS_WRITE) {
            dismissLoadingProgressDialog();
            mHandler.removeMessages(0);
    ...
    private void getAdvParams() {
        int msgId = MQTTConstants.CONFIG_MSG_ID_BLE_MK_PIR_ADV_PARAMS_READ;
    ...
    private void setAdvParamsConfig() {
        int msgId = MQTTConstants.CONFIG_MSG_ID_BLE_MK_PIR_ADV_PARAMS_WRITE;
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("mac", mMac);
