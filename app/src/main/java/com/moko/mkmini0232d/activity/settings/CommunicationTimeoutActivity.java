package com.moko.mkmini0232d.activity.settings;
...
import com.moko.mkmini0232d.databinding.ActivityCommunicationTimeoutMini0232dBinding;
...
public class CommunicationTimeoutActivity extends BaseActivity<ActivityCommunicationTimeoutMini0232dBinding> {
    ...
    @Override
    protected ActivityCommunicationTimeoutMini0232dBinding getViewBinding() {
        return ActivityCommunicationTimeoutMini0232dBinding.inflate(getLayoutInflater());
    }
    ...
    private void setCommunicationTimeout(int timeout) {
        ...
        if (mMokoDevice.deviceType == 0x71) msgId = MQTTConstants.CONFIG_MSG_ID_BLE_CONNECT_TIMEOUT;
    ...
    private void getCommunicationTimeout() {
        ...
        if (mMokoDevice.deviceType == 0x71) msgId = MQTTConstants.READ_MSG_ID_BLE_CONNECT_TIMEOUT;
