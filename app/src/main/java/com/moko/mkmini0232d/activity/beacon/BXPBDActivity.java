...
import com.moko.mkmini0232d.databinding.ActivityBxpBDInfoMini0232dBinding;
...
public class BXPBDActivity extends BaseActivity<ActivityBxpBDInfoMini0232dBinding> {
    ...
    @Override
    protected ActivityBxpBDInfoMini0232dBinding getViewBinding() {
        return ActivityBxpBDInfoMini0232dBinding.inflate(getLayoutInflater());
    }
