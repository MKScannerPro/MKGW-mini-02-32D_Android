...
import com.moko.mkmini0232d.databinding.FragmentGeneralApp20dBinding;
import com.moko.mkmini0232d.utils.ToastUtils;

public class General20DFragment extends Fragment {
    private static final String TAG = General20DFragment.class.getSimpleName();
    private FragmentGeneralApp20dBinding mBind;
    private boolean cleanSession;
    private int qos;
    private int keepAlive;

    public General20DFragment() {
    }

    public static General20DFragment newInstance() {
        return new General20DFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBind = FragmentGeneralApp20dBinding.inflate(inflater, container, false);
