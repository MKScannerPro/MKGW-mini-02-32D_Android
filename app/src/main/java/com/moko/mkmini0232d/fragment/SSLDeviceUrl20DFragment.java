...
import com.moko.mkmini0232d.activity.set.ModifyMQTTSettings20DActivity;
import com.moko.mkmini0232d.databinding.FragmentSslDeviceUrl20dBinding;
import com.moko.mkmini0232d.dialog.Bottom20DDialog;

import java.util.ArrayList;

public class SSLDeviceUrl20DFragment extends Fragment {
    private static final String TAG = SSLDeviceUrl20DFragment.class.getSimpleName();
    private FragmentSslDeviceUrl20dBinding mBind;
    private ModifyMQTTSettings20DActivity activity;
    ...
    public SSLDeviceUrl20DFragment() {
    }

    public static SSLDeviceUrl20DFragment newInstance() {
        return new SSLDeviceUrl20DFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBind = FragmentSslDeviceUrl20dBinding.inflate(inflater, container, false);
        activity = (ModifyMQTTSettings20DActivity) getActivity();
